...
#define SERVER_STRING               "Server: SMhttpd/0.1\r\n"
...
void enter_server_loop(int server_socket)
{
    ...
    printf("SmHTTPd server - entering server loop\n.");
    while (1)
    {
    ...
    printf("SmHTTPd server - handling client request  \n.");
 ...
 * handler for SIGINT, like we setup in iain().
 *
...
int main(int argc, char *argv[])
{
    ...
    printf("SmHTTPd server listening on port %d\n", server_port);
